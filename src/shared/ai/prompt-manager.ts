...
export class PromptManager {
  ...
  /**
   * Replace context placeholder in a prompt template
   * @param promptId The prompt ID
   * @param context Context to insert
   * @returns Formatted prompt with context inserted
   */
  static formatPromptWithContext(promptId: string, context: string): string {
